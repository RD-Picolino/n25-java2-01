...
public class JavaFX_Exercicio01 extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		// Criando a cena
		Scene cena = new Scene(noRoot, 600, 400, Color.CORNSILK);
	...
	private void criarComponentes(Group noRoot) {
		...
		// Ajustando posições retangulo
		cmp02.setLayoutY(50);
		cmp02.setLayoutX(50);
		cmp02.setStroke(Color.ORANGE);
		cmp02.setStrokeWidth(5);
		// Ajustando posições do texto
		// https://docs.oracle.com/javafx/2/text/jfxpub-text-.tm
		cmp03.setLayoutY(230);
		cmp03.setLayoutX(230);
		...
		cmp03.setStrokeType(StrokeType.OUTSIDE);// Setando o contorno para fora
		cmp03.setStrokeLineCap(StrokeLineCap.ROUND);// Arredondando os cantos da borda criada
		cmp03.setStrokeLineJoin(StrokeLineJoin.ROUND);// Arredondando as junções
		DropShadow ds = new DropShadow(); // Criando o efeito de sombra
		ds.setColor(Color.BLACK);
		cmp03.setEffect(ds); // Aplicando o efeito de sombra
		// Ajustando posições do Duke
		cmp04.setLayoutY(20);
		cmp04.setLayoutX(450);
	}
